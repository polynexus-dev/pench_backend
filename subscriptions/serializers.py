...
class SubscriptionSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'pause_updated_by', 'pause_updated_by_name',
    ...
    def create(self, validated_data):
        ...
        if request and request.user:
            if validated_data.get('is_paused') or validated_data.get('pause_start') or validated_data.get('pause_end'):
    ...
    def update(self, instance, validated_data):
        ...
        request = self.context.get('request')
        if request and request.user:
            is_paused_changed = 'is_paused' in validated_data and validated_data['is_paused'] != instance.is_paused
            pause_start_changed = 'pause_start' in validated_data and validated_data['pause_start'] != instance.pause_start
            pause_end_changed = 'pause_end' in validated_data and validated_data['pause_end'] != instance.pause_end
