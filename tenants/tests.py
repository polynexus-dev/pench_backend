...
class CityFilteringTestCase(TenantTestCase):
    ...
    def setUp(self):
        ...
        self.company_a = Company.objects.create(
            name="Company Alpha", code="ALPHA", is_active=True
        )
        self.company_b = Company.objects.create(
            name="Company Beta", code="BETA", is_active=True
        )
    ...
    def test_list_cities_no_filter(self):
        response = self.client.get(
            "/api/erp/tenants/cities/", HTTP_HOST="tenant.test.com"
        )
    ...
    def test_list_cities_filter_by_company_id_direct(self):
        ...
        response = self.client.get(
            f"/api/erp/tenants/cities/?company={self.company_a.id}",
    ...
    def test_list_cities_filter_by_company_id_explicit(self):
        ...
        response = self.client.get(
            f"/api/erp/tenants/cities/?company_id={self.company_b.id}",
            HTTP_HOST="tenant.test.com",
        )
        self.assertEqual(response.status_code, 200)
    ...
    def test_list_cities_filter_by_company_code_direct(self):
        ...
        response = self.client.get(
            "/api/erp/tenants/cities/?company=ALPHA", HTTP_HOST="tenant.test.com"
        )
        self.assertEqual(response.status_code, 200)
        self.assertEqual(len(response.data), 2)
    ...
    def test_list_cities_filter_by_company_code_explicit(self):
        ...
        response = self.client.get(
            "/api/erp/tenants/cities/?company_code=BETA", HTTP_HOST="tenant.test.com"
        )
        self.assertEqual(response.status_code, 200)
        self.assertEqual(len(response.data), 1)
        self.assertEqual(response.data[0]["id"], self.city_3.id)
    ...
    def test_list_cities_filter_by_company_name_explicit(self):
        ...
        response = self.client.get(
            "/api/erp/tenants/cities/?company_name=Beta", HTTP_HOST="tenant.test.com"
        )
        self.assertEqual(response.status_code, 200)
        self.assertEqual(len(response.data), 1)
        self.assertEqual(response.data[0]["id"], self.city_3.id)
